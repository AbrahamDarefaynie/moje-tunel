...
class RobotExtension extends Autodesk.Viewing.Extension {
    ...
    setTransformation() {
        ...
        //  // /* ====================== left 0 ================= */
        let ID_BaseRod10 = 650;
        let ID_LowerArmBody10 = 650;
        ...
        console.log(Position_LowerArmBody10);
         ...
         // /* ====================== left 1 ================= */
        let ID_BaseRod11 = 655;
        let ID_LowerArmBody11 = 655;
        ...
        console.log(Position_LowerArmBody11);
         ...
         // /* ====================== left 2 ================= */
        let ID_BaseRod12 = 660;
        let ID_LowerArmBody12 = 660;
        ...
        console.log(Position_LowerArmBody12);
         ...
         // /* ====================== left 3 ================= */
        let ID_BaseRod13 = 665;
        let ID_LowerArmBody13 = 665;
        ...
        console.log(Position_LowerArmBody13);
         ...
         // /* ====================== left 4 ================= */
        let ID_BaseRod14 = 670;
        let ID_LowerArmBody14 = 670;
        ...
        console.log(Position_LowerArmBody14);
         ...
         // /* ====================== left 5 ================= */
        let ID_BaseRod15 = 675;
        let ID_LowerArmBody15 = 675;
...
const someViewerState = {
    "seedURN": "dXJuOmFkc2sub2JqZWN0czpvcy5vYmplY3Q6aWZjcG9zdG1hbjYvbm9pc2ViYXJyaWVydHVubmVsLmlmYw",
    "objectSet": [
        {
            "id": [],
            "isolated": [],
