...
//updated-commented
const FORGE_MODEL_URN = 'dXJuOmFkc2sub2JqZWN0czpvcy5vYmplY3Q6aWZjcG9zdG1hbjYvbm9pc2ViYXJyaWVydHVubmVsLmlmYw';
...
const IOT_PANEL_STYLES = {
    ...
    'IoT.SensorHeatmaps': { left: '10px', top: '220px', width: '300px', height: '150px' } 
};
...
viewer.addEventListener(Autodesk.Viewing.GEOMETRY_LOADED_EVENT, async function () {
    ...
    //RobotExtension, {left:'10px', top:'320px', width: '300px', height: '200px'};
    //viewer.impl.setPostProcessParameter('RobotExtension');
    //viewer.loadDocumentNode('RobotExtension')


    // const RobotExt = viewer.getExtension('Autodesk.AEC.RobotExtension');
    // RobotExt.RobotExtensionPanel.setVisible(true);
    // RobotExtensionPanel, {left:'10px', top:'320px', width: '300px', height: '200px'};
