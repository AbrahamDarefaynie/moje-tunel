...
export class EditorExtension extends Autodesk.Viewing.Extension {
    ...
    load() {
        ...
        if (this.viewer.toolbar) {
            ...
            this.viewer.addEventListener(av.TOOLBAR_CREATED_EVENT, this.waitForToolbarCreation);
        }
    ...
    waitForToolbarCreation() {
        this.viewer.removeEventListener(av.TOOLBAR_CREATED_EVENT, this.waitForToolbarCreation);
        this.createUI();
    }
